!function(t, e, n) {
    ...
    function r(t) {
        return function() {
            var e,
                n = arguments[0],
                n = "[" + (t ? t + ":" : "") + n + "] http://errors.angularjs.org/1.2.27/" + (t ? t + "/" : "") + n;
    ...
    function o(t, e, n) {
        ...
        if (t)
            if (S(t))
                for (r in t)
                    "prototype" == r || "length" == r || "name" == r || t.hasOwnProperty && !t.hasOwnProperty(r) || e.call(n, t[r], r);
            else if (sr(t) || i(t))
    ...
    function c() {
        for (var t, e = or.length; e;) {
            if (e--, t = or[e].charCodeAt(0), 57 == t)
                return or[e] = "A", or.join("");
            if (90 != t)
                return or[e] = String.fromCharCode(t + 1), or.join("");
            or[e] = "0"
        }
    ...
    function M(t, e, n, r) {
        ...
        if (e) {
            ...
            if (sr(t))
                for (var s = e.length = 0; s < t.length; s++)
                    i = M(t[s], null, n, r), y(t[s]) && (n.push(t[s]), r.push(i)), e.push(i);
            else {
                var a = e.$$hashKey;
                ...
                for (s in t)
                    i = M(t[s], null, n, r), y(t[s]) && (n.push(t[s]), r.push(i)), e[s] = i;
                l(e, a)
            }
        } else
            (e = t) && (sr(t) ? e = M(t, [], n, r) : x(t) ? e = new Date(t.getTime()) : C(t) ? (e = RegExp(t.source, t.toString().match(/[^\/]*$/)[0]), e.lastIndex = t.lastIndex) : y(t) && (e = M(t, {}, n, r)));
        return e
    }
    function N(t, e) {
        if (sr(t)) {
            ...
            for (n in e = e || {}, t)
                !Zn.call(t, n) || "$" === n.charAt(0) && "$" === n.charAt(1) || (e[n] = t[n]);
        return e || t
    }
    function P(t, e) {
        if (t === e)
        ...
        if (i == typeof e && "object" == i) {
            if (!sr(t)) {
                if (x(t))
                    return x(e) ? isNaN(t.getTime()) && isNaN(e.getTime()) || t.getTime() === e.getTime() : !1;
                if (C(t) && C(e))
                    return t.toString() == e.toString();
                if (t && t.$evalAsync && t.$watch || e && e.$evalAsync && e.$watch || k(t) || k(e) || sr(e))
                    return !1;
                i = {};
                for (r in t)
                    if ("$" !== r.charAt(0) && !S(t[r])) {
                ...
                for (r in e)
                    if (!i.hasOwnProperty(r) && "$" !== r.charAt(0) && e[r] !== n && !S(e[r]))
                        return !1;
                return !0
            }
            if (!sr(e))
    ...
    function X(t, e, n) {
        if (!e)
            return t;
        e = e.split(".");
        for (var r, i = t, o = e.length, s = 0; o > s; s++)
            r = e[s], t && (t = (i = t)[r]);
        return !n && S(t) ? j(i, t) : t
    }
    function K(t) {
        var e = t[0];
        if (t = t[t.length - 1], e === t)
            return Wn(e);
        var n = [e];
        do {
    ...
    function Y(e) {
        ...
        Gn("ng", ["ngLocale"], ["$provide", function(t) {
            t.provider({
                $$sanitizeUri: vn
            }), t.provider("$compile", Oe).directive({
                a: ai,
                input: mi,
                textarea: mi,
                form: fi,
                ...
                ngInclude: Hi
            }).directive(ui).directive(qi), t.provider({
                $anchorScroll: xe,
                $animate: Pr,
                $browser: ke,
                $cacheFactory: Ae,
    ...
    function ee(t, e, n, r) {
        function i(t) {
            var i,
                ...
                c,
                l,
                f = n && t ? [this.filter(t)] : [this],
                h = e;
            if (!r || null != t)
                for (; f.length;)
                    for (i = f.shift(), s = 0, a = i.length; a > s; s++)
                        for (u = Wn(i[s]), h ? u.triggerHandler("$destroy") : h = !h, c = 0, u = (l = u.children()).length; u > c; c++)
                            f.push(Qn(l[c]));
    ...
    function ne(t) {
        ...
        if (w(t)) {
            ...
            var r;
            if (r = mr.exec(n))
                t = [t.createElement(r[1])];
            else {
                var i,
                    o = t;
                if (t = o.createDocumentFragment(), r = [], yr.test(n)) {
                    for (o = t.appendChild(o.createElement("div")), i = (wr.exec(n) || ["", ""])[1].toLowerCase(), i = xr[i] || xr._default, o.innerHTML = "<div>&#160;</div>" + i[1] + n.replace(br, "<$1></$2>") + i[2], o.removeChild(o.firstChild), n = i[0]; n--;)
                        o = o.lastChild;
                    for (n = 0, i = o.childNodes.length; i > n; ++n)
                        r.push(o.childNodes[n]);
                    o = t.firstChild, o.textContent = ""
                } else
                    r.push(o.createTextNode(n));
    ...
    function $e(t, e, r) {
        for (9 == t.nodeType && (t = t.documentElement), e = sr(e) ? e : [e]; t;) {
            for (var i = 0, o = e.length; o > i; i++)
                if ((r = Wn.data(t, e[i])) !== n)
                    return r;
            t = t.parentNode || 11 === t.nodeType && t.host
        }
    }
    function de(t) {
        for (var e = 0, n = t.childNodes; e < n.length; e++)
            ie(n[e]);
        for (; t.firstChild;)
    ...
    function be(t) {
        ...
        function n(t, e) {
            if (J(t, "service"), (S(e) || sr(e)) && (e = p.instantiate(e)), !e.$get)
                throw Mr("pget", t);
            return h[t + c] = e
        }
        function r(t, e) {
        ...
        function i(t) {
            ...
            return o(t, function(t) {
                if (!f.get(t)) {
                    ...
                    try {
                        if (w(t))
                            for (e = Gn(t), a = a.concat(i(e.requires)).concat(e._runBlocks), n = e._invokeQueue, r = 0, s = n.length; s > r; r++) {
                                var o = n[r],
                                    u = p.get(o[0]);
                                u[o[1]].apply(u, o[2])
                            }
                        else
                            S(t) ? a.push(p.invoke(t)) : sr(t) ? a.push(p.invoke(t)) : G(t, "module")
                    } catch (c) {
            ...
            if (!t) {
                if (l.cookie !== T)
                    for (T = l.cookie, i = T.split("; "), O = {}, s = 0; s < i.length; s++)
                        o = i[s], a = o.indexOf("="), a > 0 && (t = unescape(o.substring(0, a)), O[t] === n && (O[t] = unescape(o.substring(a + 1))));
                return O
            }
        ...
        this.directive = function h(e, n) {
            return J(e, "directive"), w(e) ? (Q(n, "directiveFactory"), i.hasOwnProperty(e) || (i[e] = [], t.factory(e + s, ["$injector", "$exceptionHandler", function(t, n) {
                ...
                return o(i[e], function(i, o) {
                    try {
                        ...
                        S(s) ? s = {
                            compile: v(s)
                        } : !s.compile && s.link && (s.compile = v(s.link)), s.priority = s.priority || 0, s.index = o, s.name = s.name || e, s.require = s.require || s.controller && s.name, s.restrict = s.restrict || "A", r.push(s)
                    } catch (a) {
                        n(a)
                    }
                }), r
            ...
            function O(t, e, r, i, o, s) {
                function a(t, r, i, o) {
                    ...
                    for (c = 0; s > c; c++)
                        $[c] = r[c];
                    for (f = c = 0, l = h.length; l > c; f++)
                        a = $[f], r = h[c++], s = h[c++], r ? (r.scope ? (u = t.$new(), Wn.data(a, "$scope", u)) : u = t, p = r.transcludeOnThisElement ? T(t, r.transclude, o) : !r.templateOnThisElement && o ? o : !o && e ? T(t, e) : null, r(s, u, a, i, p)) : s && s(t, a.childNodes, n, o)
                }
                for (var u, c, l, f, h = [], p = 0; p < t.length; p++)
                    u = new X, c = M(t[p], [], u, 0 === p ? i : n, o), (s = c.length ? R(c, t[p], u, e, r, null, [], [], s) : null) && s.scope && E(u.$$element, "ng-scope"), u = s && s.terminal || !(l = t[p].childNodes) || !l.length ? null : O(l, s ? (s.transcludeOnThisElement || !s.templateOnThisElement) && s.transclude : e), h.push(s, u), f = f || s || u, s = null;
                return f ? a : null
            }
            function T(t, e, n) {
                return function(r, i, o) {
            ...
            function M(t, e, n, r, i) {
                ...
                case 1:
                    ...
                    if (t = t.className, w(t) && "" !== t)
                        for (; o = c.exec(t);)
                            u = Te(o[2]), U(e, u, "C", r, i) && (n[u] = ar(o[3])), t = t.substr(o.index + o[0].length);
                    break;
                case 3:
                    L(e, t.nodeValue);
                    break;
            ...
            function R(t, i, s, a, c, l, f, h, p) {
                function $(t, e, n, r) {
                    t && (n && (t = D(t, n, r)), t.require = x.require, t.directiveName = C, (U === x || x.$$isolateScope) && (t = J(t, {
                        isolateScope: !0
                    })), f.push(t)), e && (n && (e = D(e, n, r)), e.require = x.require, e.directiveName = C, (U === x || x.$$isolateScope) && (e = J(e, {
                        isolateScope: !0
                    })), h.push(e))
                }
                function d(t, e, n, r) {
                    ...
                    if (w(e)) {
                        for (; "^" == (i = e.charAt(0)) || "?" == i;)
                            e = e.substr(1), "^" == i && (s = "inheritedData"), a = a || "?" == i;
                        if (i = null, r && "data" === s && (i = r[e]), i = i || n[s]("$" + e + "Controller"), !i && !a)
                            throw jr("ctreq", e, t)
                    } else
                        sr(e) && (i = [], o(e, function(e) {
                            i.push(d(t, e, n, r))
                        }));
                    return i
                }
                function m(t, e, a, c, l) {
                    ...
                    }), c = 0, y = f.length; y > c; c++)
                        try {
                            (w = f[c])(w.isolateScope ? x : e, m, $, w.require && d(w.directiveName, w.require, m, C), S)
                        } catch (A) {
                            u(A, q(m))
                        }
                    for (c = e, U && (U.template || null === U.templateUrl) && (c = x), t && t(c, a.childNodes, n, l), c = h.length - 1; c >= 0; c--)
                        try {
                ...
                for (var b, x, C, k, O, T = -Number.MAX_VALUE, R = p.controllerDirectives, U = p.newIsolateScopeDirective, I = p.templateDirective, L = p.nonTlbTranscludeDirective, z = !1, B = !1, W = p.hasElementTranscludeDirective, Q = s.$$element = Wn(i), K = a, Z = 0, te = t.length; te > Z; Z++) {
                    ...
                    var ee = x.$$start,
                        ne = x.$$end;
                    if (ee && (Q = j(i, ee, ne)), k = n, T > x.priority)
                        break;
                    if ((k = x.scope) && (b = b || x, x.templateUrl || (H("new/isolated scope", U, x, Q), y(k) && (U = x))), C = x.name, !x.templateUrl && x.controller && (k = x.controller, R = R || {}, H("'" + C + "' controller", R[C], x, Q), R[C] = x), (k = x.transclude) && (z = !0, x.$$tlb || (H("transclusion", L, x, Q), L = x), "element" == k ? (W = !0, T = x.priority, k = Q, Q = s.$$element = Wn(e.createComment(" " + C + ": " + s[C] + " ")), i = Q[0], G(c, tr.call(k, 0), i), K = A(k, a, T, l && l.name, {
                        nonTlbTranscludeDirective: L
                    })) : (k = Wn(re(i)).contents(), Q.empty(), K = A(k, a))), x.template)
                        if (B = !0, H("template", I, x, Q), I = x, k = S(x.template) ? x.template(Q, s) : x.template, k = Y(k), x.replace) {
                            if (l = x, k = yr.test(k) ? Wn(ar(k)) : [], i = k[0], 1 != k.length || 1 !== i.nodeType)
                                throw jr("tplrt", C, "");
                            G(c, Q, i), te = {
                                $attr: {}
                            }, k = M(i, [], te);
                            ...
                            Q.html(k);
                    if (x.templateUrl)
                        B = !0, H("template", I, x, Q), I = x, x.replace && (l = x), m = _(t.splice(Z, t.length - Z), Q, s, c, z && K, f, h, {
            ...
            function _(t, e, n, r, i, s, a, u) {
                ...
                return e.empty(), h.get(x.getTrustedResourceUrl(m), {
                    ...
                    var h,
                        $;
                    if (f = Y(f), v.replace) {
                        if (f = yr.test(f) ? Wn(ar(f)) : [], h = f[0], 1 != f.length || 1 !== h.nodeType)
                            throw jr("tplrt", v.name, m);
                        f = {
                            $attr: {}
                        }, G(r, e, h);
                        var w = M(h, [], f);
            ...
            function H(t, e, n, r) {
                if (e)
                    throw jr("multidir", e.name, n.name, t, q(r))
            }
            function L(t, e) {
                var n = r(e, !0);
                n && t.push({
            ...
            function B(t, e, n, i) {
                var o = r(n, !0);
                if (o) {
                    if ("multiple" === i && "SELECT" === Jn(t))
                        throw jr("selmulti", q(t));
                    e.push({
                        priority: 100,
                        compile: function() {
                            return {
            ...
            function G(t, n, r) {
                ...
                if (t)
                    for (i = 0, o = t.length; o > i; i++)
                        if (t[i] == s) {
                            t[i++] = r, o = i + a - 1;
                            for (var c = t.length; c > i; i++, o++)
                                c > o ? t[i] = t[o] : delete t[i];
                            t.length -= a - 1;
                            break
                        }
                for (u && u.replaceChild(r, s), t = e.createDocumentFragment(), t.appendChild(s), r[Wn.expando] = s[Wn.expando], s = 1, a = n.length; a > s; s++)
                    u = n[s], Wn(u).remove(), t.appendChild(u), delete n[s];
                n[0] = r, n.length = 1
            }
            function J(t, e) {
                return f(function() {
    ...
    function Ue() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(t, e, r, i, l, h) {
            function p(t) {
                function e(t) {
                    var e = f({}, t, {
                        data: Ve(t.data, t.headers, r.transformResponse)
                    });
            ...
            function $(r, o, a) {
                ...
                var h,
                    ...
                    b = w.promise,
                    x = d(r.url, r.params);
                if (p.pendingRequests.push(r), b.then(f, f), !r.cache && !s.cache || !1 === r.cache || "GET" !== r.method && "JSONP" !== r.method || (h = y(r.cache) ? r.cache : y(s.cache) ? s.cache : v), h)
                    if ($ = h.get(x), m($)) {
                        if ($ && S($.then))
                            return $.then(f, f), $;
    ...
    function qe(e) {
        if (8 >= Bn && (!e.match(/^(get|post|head|put|delete|options)$/i) || !t.XMLHttpRequest))
    ...
    function _e(t, e, n, r, i) {
        function s(t, e, n) {
            ...
            return o.type = "text/javascript", o.src = t, o.async = !0, s = function(t) {
                ...
                w(o.readyState) && /loaded|complete/.test(o.readyState) && (o.onreadystatechange = null, s({
                    type: "load"
                }))
                ...
                return !u || d ? (v.length = $, h = function(t) {
                    try {
                        for (var e, n = 0, s = $; s > n; n++) {
                            if ("function" == typeof (e = p[n]))
                                if (e = e(t), e = c ? i.getTrusted(c, e) : i.valueOf(e), null == e)
                                    e = "";
                                else
                                    switch (typeof e) {
                                    case "string":
        ...
        this.hashPrefix = function(t) {
            ...
            s.on("click", function(e) {
                if (!e.ctrlKey && !e.metaKey && 2 != e.which) {
                    for (var n = Wn(e.target); "a" !== Kn(n[0].nodeName);)
    ...
    function on(t, e) {
        if (t) {
            if (t.constructor === t)
                throw _r("isecfn", e);
            if (t.document && t.location && t.alert && t.setInterval)
                throw _r("isecwindow", e);
    ...
    function ln(t, e, r) {
        ...
        var a,
            ...
            c = u.length;
        if (e.csp)
            a = 6 > c ? un(u[0], u[1], u[2], u[3], u[4], r, e) : function(t, i) {
                var o,
                    s = 0;
                do o = un(u[s++], u[s++], u[s++], u[s++], u[s++], r, e)(t, i), i = n, t = o;
                while (c > s);
                return o
            };
        else {
                    ...
                    resolve: function(e) {
                        if (l) {
                            ...
                            l = n, o = a(e), r.length && t(function() {
                                for (var t, e = 0, n = r.length; n > e; e++)
            ...
            l.prototype = {
                ...
                $watchCollection: function(t, e) {
                    ...
                    return this.$watch(function() {
                        ...
                        if (y(n))
                            if (i(n))
                                for (r !== f && (r = f, $ = r.length = 0, c++), t = n.length, $ !== t && (c++, r.length = $ = t), e = 0; t > e; e++)
                                    o = r[e] !== r[e] && n[e] !== n[e], o || r[e] === n[e] || (c++, r[e] = n[e]);
                            else {
                                r !== h && (r = h = {}, $ = 0, c++), t = 0;
                                for (e in n)
                                    n.hasOwnProperty(e) && (t++, r.hasOwnProperty(e) ? (o = r[e] !== r[e] && n[e] !== n[e], o || r[e] === n[e] || (c++, r[e] = n[e])) : ($++, r[e] = n[e], c++));
                                if ($ > t)
                                    for (e in c++, r)
                                        r.hasOwnProperty(e) && !n.hasOwnProperty(e) && ($--, delete r[e])
                            }
                        else
                            r !== n && (r = n, c++);
                        return c
                        ...
                        do {
                            if (a = h.$$watchers)
                                for (c = a.length; c--;)
                                    try {
                                        if (r = a[c])
                                            if ((i = r.get(h)) === (o = r.last) || (r.eq ? P(i, o) : "number" == typeof i && "number" == typeof o && isNaN(i) && isNaN(o))) {
                                                if (r === n) {
                                                    l = !1;
                                                    break t
                                                }
                                            } else
                                                l = !0, n = r, r.last = r.eq ? M(i, null) : i, r.fn(i, o === d ? i : o, h), 5 > w && (p = 4 - w, b[p] || (b[p] = []), $ = S(r.exp) ? "fn: " + (r.exp.name || r.exp.toString()) : r.exp, $ += "; newVal: " + R(i) + "; oldVal: " + R(o), b[p].push($))
                                    } catch (C) {
                                        v.$$phase = null, s(C)
                                    }
                            if (!(a = h.$$childHead || h !== this && h.$$nextSibling))
                                for (; h !== this && !(a = h.$$nextSibling);)
                                    h = h.$parent
                        } while (h = a);
                        if ((l || m.length) && !w--)
                            throw v.$$phase = null, e("infdig", t, R(b))
                    } while (l || m.length);
                    for (v.$$phase = null; y.length;)
                        try {
                            y.shift()()
                        } catch (k) {
                            s(k)
                ...
                $broadcast: function(t) {
                    for (var e, n, r = this, i = this, o = {
                        ...
                        for (o.currentScope = r, i = r.$$listeners[t] || [], e = 0, n = i.length; n > e; e++)
                            if (i[e])
                                try {
                                    i[e].apply(null, a)
                                } catch (u) {
                ...
                getTrusted: function(r, i) {
                    ...
                    if (r === Zr.RESOURCE_URL) {
                        var u,
                            ...
                            s = Sn(i.toString()),
                            l = !1;
                        for (u = 0, c = t.length; c > u; u++)
                            if ("self" === t[u] ? Cn(s) : t[u].exec(s.href)) {
                                l = !0;
                                break
                            }
                        if (l)
                            for (u = 0, c = e.length; c > u; u++)
                                if ("self" === e[u] ? Cn(s) : e[u].exec(s.href)) {
                                    l = !1;
                                    break
                                }
                        if (l)
    ...
    function bn() {
        this.$get = ["$window", "$document", function(t, e) {
            var n,
                r = {},
                i = h((/android (\d+)/.exec(Kn((t.navigator || {}).userAgent)) || [])[1]),
        ...
        return function(t, e, n) {
            ...
            i.check = function(t) {
                ...
                if (t && e && "object" == typeof t && "object" == typeof e) {
                    for (var r in t)
                        if ("$" !== r.charAt(0) && Zn.call(t, r) && n(t[r], e[r]))
                            return !0;
                    return !1
                }
    ...
    function Dn(t) {
        ...
        return function(n, r) {
            var i,
                ...
                a = "",
                u = [];
            if (r = r || "mediumDate", r = t.DATETIME_FORMATS[r] || r, w(n) && (n = ii.test(n) ? h(n) : e(n)), b(n) && (n = new Date(n)), !x(n))
                return n;
            for (; r;)
                (s = ri.exec(r)) ? (u = u.concat(tr.call(s, 1)), r = u.pop()) : (u.push(r), r = null);
    ...
    function Vn() {
        return function(t, e) {
            if (!sr(t) && !w(t))
                return t;
            if (e = 1 / 0 === Math.abs(Number(e)) ? Number(e) : h(e), w(t))
                return e ? e >= 0 ? t.slice(0, e) : t.slice(e, t.length) : "";
            var n,
                r,
                i = [];
            for (e > t.length ? e = t.length : e < -t.length && (e = -t.length), e > 0 ? (n = 0, r = e) : (n = t.length + e, r = t.length); r > n; n++)
                i.push(t[n]);
            return i
        }
    }
    ...
    function Fn(t, e, n, r) {
        ...
        s.$name = e.name || e.ngForm, s.$dirty = !1, s.$pristine = !0, s.$valid = !0, s.$invalid = !1, a.$addControl(s), t.addClass(bi), i(!0), s.$addControl = function(t) {
            ...
            var r = c[t];
            if (e)
                r && (T(r, n), r.length || (u--, u || (i(e), s.$valid = !0, s.$invalid = !1), c[t] = !1, i(!0, t), a.$setValidity(t, !0, s)));
            else {
                if (u || i(e), r) {
                    if (-1 != O(r, n))
                        return
                } else
                    c[t] = r = [], u++, i(!1, t), a.$setValidity(t, !1, s);
    ...
    function Ln(t, e, n, i, o, s) {
        ...
        if (v && ((o = v.match(/^\/(.*)\/([gim]*)$/)) ? (v = RegExp(o[1], o[2]), o = function(t) {
            ...
            var o = t.$eval(v);
            if (!o || !o.test)
                throw r("ngPattern")("noregexp", v, o, q(e));
    ...
    var fr = ne.cache = {},
        hr = 1,
        pr = t.document.addEventListener ? function(t, e, n) {
    ...
    o("input select option textarea button form details".split(" "), function(t) {
        ...
        ne.prototype[e] = function(e, n, r) {
            for (var i, o = 0; o < this.length; o++)
                g(i) ? (i = t(this[o], e, n, r), m(i) && (i = Wn(i))) : he(i, t(this[o], e, n, r));
            return m(i) ? i : this
    ...
    Qr.prototype = {
        ...
        readIdent: function() {
            ...
            if (s = {
                ...
                s.fn = Br[o], s.literal = !0, s.constant = !0;
            else {
        ...
        readString: function(t) {
            ...
            for (var n = "", r = t, i = !1; this.index < this.text.length;) {
                var o = this.text.charAt(this.index),
                    r = r + o;
                if (i)
                    "u" === o ? (i = this.text.substring(this.index + 1, this.index + 5), i.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + i + "]"), this.index += 4, n += String.fromCharCode(parseInt(i, 16))) : n += Wr[o] || o, i = !1;
                else if ("\\" === o)
                    i = !0;
                else {
                    if (o === t)
        ...
        functionCall: function(t, e) {
            ...
            return function(i, o) {
                for (var s = [], a = e ? e(i, o) : i, u = 0; u < n.length; u++)
                    s.push(on(n[u](i, o), r.text));
                u = t(i, o, a) || $, on(a, r.text);
                var c = r.text;
                if (u) {
                    if (u.constructor === u)
                        throw _r("isecfn", c);
                    if (u === Hr || u === Lr || zr && u === zr)
                        throw _r("isecff", c)
                }
    ...
    var Jr = {},
        ...
        Yr = e.createElement("a"),
        ti = Sn(t.location.href, !0);
    ...
    var li = function(t) {
        ...
        $i = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,
        di = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
        vi = {
            text: Ln,
        ...
        gi = ["badInput"],
        mi = ["$browser", "$sniffer", function(t, e) {
            return {
                restrict: "E",
                require: "?ngModel",
        ...
        bi = "ng-pristine",
        xi = "ng-dirty",
        Si = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", function(t, e, n, i, s, a) {
            function u(t, e) {
            ...
            var c = s(n.ngModel),
                l = c.assign;
            if (!l)
                throw r("ngModel")("nonassign", n.ngModel, q(i));
            this.$render = $, this.$isEmpty = function(t) {
                return g(t) || "" === t || null === t || t !== t
            };
            var f = i.inheritedData("$formController") || ci,
                h = 0,
                p = this.$error = {};
    ...
    var _i = ["$animate", function(t) {
        ...
        Bi = ["$locale", "$interpolate", function(t, e) {
            var n = /{}/g;
            return {
                restrict: "EA",
                link: function(r, i, s) {
                    var a = s.count,
                        u = s.$attr.when && i.attr(s.$attr.when),
                        c = s.offset || 0,
                        l = r.$eval(u) || {},
                        f = {},
                        h = e.startSymbol(),
            ...
            return {
                ...
                link: function(r, a, u, c, l) {
                    var f,
                        ...
                        v,
                        g = u.ngRepeat,
                        m = g.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/),
                        y = {
                            $id: me
                        };
                    if (!m)
                    ...
                    r.$watchCollection(c, function(t) {
                        ...
                        if (i(t))
                            ...
                            S = h || $, C = [];
                            for (b in t)
                                t.hasOwnProperty(b) && "$" != b.charAt(0) && C.push(b);
                            C.sort()
                        }
                        for (m = C.length, c = O.length = C.length, u = 0; c > u; u++)
                            if (b = t === C ? u : C[u], x = t[b], f = S(b, x, u), J(f, "`track by` id"), w.hasOwnProperty(f))
                                k = w[f], delete w[f], E[f] = k, O[u] = k;
                            else {
                        ...
                        for (b in w)
                            w.hasOwnProperty(b) && (k = w[b], u = K(k.clone), n.leave(u), o(u, function(t) {
                                t.$$NG_REMOVED = !0
                            }), k.scope.$destroy());
        ...
        Yi = qn({
            link: function(t, e, n, i, o) {
                if (!o)
                    throw r("ngTransclude")("orphan", q(e));
                o(function(t) {
                    e.empty(), e.append(t)
                })
            }
                ...
                link: function(a, u, c, l) {
                    ...
                    function p(e, o, a) {
                        function u() {
                            ...
                            var k,
                                ...
                                O = h ? s(i) : i;
                            if (A = {}, E = !1, v)
                                if (n = a.$modelValue, S && sr(n))
                                    for (E = new ye([]), t = {}, u = 0; u < n.length; u++)
                                        t[f] = n[u], E.put(S(e, t), n[u]);
                                else
                                    E = new ye(n);
                            u = E;
                            var T,
                            ...
                            for (v || (w || null === r ? c[""].unshift({
                                ...
                                for (E++; i.length > E;)
                                    t = i.pop(), $.removeOption(t.label), t.element.remove()
                            }
                            for (; C.length > A;)
                                C.pop()[0].element.remove()
                        }
                        var c;
                        if (!(c = y.match(i)))
                            throw eo("iexp", y, q(o));
                        ...
                        w && (t(w)(e), w.removeClass("ng-scope"), w.remove()), o.empty(), o.on("change", function() {
                            e.$apply(function() {
                                var t,
                                    ...
                                    y = {};
                                if (v) {
                                    for (i = [], c = 0, p = C.length; p > c; c++)
                                        for (t = C[c], s = 1, l = t.length; l > s; s++)
                                            if ((r = t[s].element)[0].selected) {
                                                if (r = r.val(), h && (y[h] = r), S)
                                                    for ($ = 0; $ < m.length && (y[f] = m[$], S(e, y) != r); $++)
                                                        ;
                                                else
                                                    y[f] = m[r];
                                                i.push(d(e, y))
                            ...
                            var t = {},
                                n = g(e);
                            if (n) {
                                for (var r = Array(n.length), i = 0, o = n.length; o > i; i++)
                                    t[f] = n[i], r[i] = l(e, t);
                                return r
                            }
                    ...
                    if (l[1]) {
                        ...
                        var d,
                            ...
                            y = c.ngOptions,
                            w = !1,
                            b = Wn(e.createElement("option")),
                            x = Wn(e.createElement("optgroup")),
                            S = b.clone();
                        c = 0;
                        for (var C = u.children(), k = C.length; k > c; c++)
                            if ("" === C[c].value) {
                                d = w = C.eq(c);
                                break
                            }
...
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdown", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html", "template/accordion/accordion.html", "template/alert/alert.html", "template/carousel/carousel.html", "template/carousel/slide.html", "template/datepicker/datepicker.html", "template/datepicker/day.html", "template/datepicker/month.html", "template/datepicker/popup.html", "template/datepicker/year.html", "template/modal/backdrop.html", "template/modal/window.html", "template/pagination/pager.html", "template/pagination/pagination.html", "template/tooltip/tooltip-html-unsafe-popup.html", "template/tooltip/tooltip-popup.html", "template/popover/popover.html", "template/progressbar/bar.html", "template/progressbar/progress.html", "template/progressbar/progressbar.html", "template/rating/rating.html", "template/tabs/tab.html", "template/tabs/tabset.html", "template/timepicker/timepicker.html", "template/typeahead/typeahead-match.html", "template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope", function(e, t, n) {
        ...
        link: function(t, n, a) {
            ...
            function l() {
                u ? (u = !1, s(), n.css({
                    ...
                    height: n[0].scrollHeight + "px"
                }), n[0].offsetWidth, n.removeClass("collapse in").addClass("collapsing"), i({
                    height: 0
                }).then(s))
            }
            function s() {
    ...
    function n(e) {
        ...
        return angular.forEach(i, function(t, i) {
            ...
            if (r > -1) {
                ...
                for (var o = r + 1, l = r + i.length; l > o; o++)
                    a[o] = "", e[o] = "$";
                e = e.join(""), n.push({
                    index: r,
                    apply: t.apply
    ...
    this.modes = ["day", "month", "year"], angular.forEach(["formatDay", "formatMonth", "formatYear", "formatDayHeader", "formatDayTitle", "formatMonthTitle", "minMode", "maxMode", "showWeeks", "startingDay", "yearRange"], function(n, i) {
        ...
        if (e.datepickerMode === s.minMode) {
            ...
            s.activeDate = t, e.datepickerMode = s.modes[s.modes.indexOf(e.datepickerMode) - 1]
    }, e.move = function(e) {
    ...
    e.$on("datepicker.focus", u), e.keydown = function(t) {
        ...
        if (n && !t.shiftKey && !t.altKey)
            if (t.preventDefault(), t.stopPropagation(), "enter" === n || "space" === n) {
                ...
                !t.ctrlKey || "up" !== n && "down" !== n ? (s.handleKeyDown(n, t), s.refreshView()) : (e.toggleMode("up" === n ? 1 : -1), u())
    }
        ...
        link: function(t, n, a, i) {
            ...
            i._refreshView = function() {
                var n = i.activeDate.getFullYear(),
                    ...
                    u = new Date(r);
                c > 0 && u.setDate(-c + 1);
                for (var p = o(u, 42), d = 0; 42 > d; d++)
                    p[d] = angular.extend(i.createDateObject(p[d], i.formatDay), {
                ...
                if ("left" === e)
                    ...
                    "home" === e ? t = 1 : "end" === e && (t = r(i.activeDate.getFullYear(), i.activeDate.getMonth()));
    ...
    return {
        ...
        link: function(t, n, a, i) {
            i.step = {
                ...
                for (var n = new Array(12), a = i.activeDate.getFullYear(), r = 0; 12 > r; r++)
                    n[r] = angular.extend(i.createDateObject(new Date(a, r, 1), i.formatMonth), {
                        uid: t.uniqueId + "-" + r
                    });
    ...
    return {
        ...
        link: function(e, t, n, a) {
            ...
            a.step = {
                ...
                for (var t = new Array(r), n = 0, o = i(a.activeDate.getFullYear()); r > n; n++)
                    t[n] = angular.extend(a.createDateObject(new Date(o + n, 0, 1), a.formatYear), {
                        uid: e.uniqueId + "-" + n
                    });
    ...
    return {
        ...
        link: function(l, s, c, u) {
            ...
            var g,
                m = angular.isDefined(c.closeOnDateSelection) ? l.$parent.$eval(c.closeOnDateSelection) : o.closeOnDateSelection,
    ...
    function o() {
        for (var e = -1, t = g.keys(), n = 0; n < t.length; n++)
            g.get(t[n]).value.backdrop && (e = n);
        return e
    }
    function l(e) {
    ...
    return i.$watch(o, function(e) {
        ...
        for (var t = this.getTop(); t;)
            this.dismiss(t.key, e), t = this.getTop()
    }, m.getTop = function() {
        return g.top()
    }, m
    ...
    return {
        ...
        link: function(s, c, u, p) {
            var d,
                g = s.$eval(u.typeaheadMinLength) || 1,
                    ...
                    if (a && d)
                        if (n.length > 0) {
                            ...
                            for (var i = 0; i < n.length; i++)
                                t[w.itemName] = n[i], k.matches.push({
                                    id: T(i),
    ...
    n.module("ngCookies", ["ng"]).factory("$cookies", ["$rootScope", "$browser", function(o, i) {
        ...
        return i.addPollFn(function() {
            ...
            for (o in c)
                s(r[o]) && i.cookies(o, e);
            for (o in r)
                t = r[o], n.isString(t) || (t = "" + t, r[o] = t), t !== c[o] && (i.cookies(o, t), f = !0);
            if (f)
                for (o in t = i.cookies(), r)
                    r[o] !== t[o] && (s(t[o]) ? delete r[o] : r[o] = t[o])
        }), r
